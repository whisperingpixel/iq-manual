...
### 2101 Unknown general system error  {#2101}
...
### 2102 General error during loading of data {#2102}
...
### 2103 General error during storing of data {#2103}
...
## Network errors
### 2201 Unknown general network error {#2201}
...
### 2202 Cannot load data because of unknown network error {#2202}
...
### 2203 Cannot save data because of unknown network error {#2203}
...
### 2204 Cannot load data because requested URL was not found {#2204}
...
### 2205 Cannot load data because of an internal server error {#2205}
...
### 2207 Error during serialisation {#2207}
...
### 2208 Syntax error during serialisation {#2208}
...
### 2220 Model can not be loaded because blocks are not accessible or empty {#2220}
...
### 2221 The basemaps associated with the factbase cannot be loaded {#2221}
...
### 2222 Retrieving blocks for a model failed {#2222}
...
### 2304 No factbase selected {#2304}
...
### 2305 At least one setting for a semantic query is missing {#2305}
...
### 2306 The submitted area-of-interest has an invalid EPSG code {#2306}
...
### 2307 The submitted area-of-interest has an invalid format or type {#2307}
...
### 2308 The submitted area-of-interest contains geometries with invalid coordinate ranges {2308}
...
### 2370 Unkonw error during logging in {2370}
...
### 2371 Unkonw error during logging out {#2371}
...
### 2372 The current session is no longer authenticated {#2372}
...
### 2373 User has not accepted usage conditions {#2373}
...
### 2402 The Blockly workspace is undefined {#2402}
...
### 2403 The model is undefined {#2403}
...
### 2405 No target field for block {#2405}
...
### 2406 Dropdown menu of a block can not be generated {#2406}
...
### 2407 Unknown block in a model {#2407}
...
### 2501 Unknown error during retrieval of a result {#2501}
...
### 2502 Result cannot be visualised because it is empty {#2502}
...
### 2503 A result map has an invalid EPSG code {#2503}
...
### 2504 A result can not be loaded because of an invalid URL {#2504}
...
### 2505 A SCBIR result is not linked to an image {#2505}
...
### 4101 Invalid area-of-interest or time period {#4101}
...
### 4201 Inferences are stopped because of user request {#4201}
...
### 4203 Inferences are stopped because of user timeout {#4203}
...
### 4204 Inferences are stopped because of global timeout {#4204}
...
### 4301 Unknown factbase status {#4301}
...
### 4302 Factbase is in maintenance status {#4302}
...
### 4303 Factbase is in disabled status {#4303}
