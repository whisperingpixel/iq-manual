...
<center>
![](img/watercountmodel.png){width=100%}
</center>

The result is a map in which each spatial location (modelled as a cell in a spatial grid) contains a *water count* value.

<center>
![](img/watercountresult.png){width=100%}
</center>

The following chapters will explain in detail how to fill up an empty model step by step, using the provided building blocks.